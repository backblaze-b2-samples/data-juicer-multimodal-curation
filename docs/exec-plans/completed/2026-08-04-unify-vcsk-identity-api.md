# Unify DJMC Identity and API Discovery

## Goal

Make Data-Juicer Multimodal Curation the canonical identity across the shipped web app,
...
The web app and local API now ship under the Data-Juicer Multimodal Curation identity.
